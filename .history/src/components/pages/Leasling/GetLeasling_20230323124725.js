        ...
        <Modal.Body>
          <Container>
            <div className="manyImage">
              {each?.leaselistingPictures?.map((i, index) => (
                <img src={i.img} alt="" key={index} />
              ))}
            </div>

            <div className="cont">
              <p className="cont-p"> Property name : {each?.Property_name} </p>
              <p className="cont-p"> Product_price : ₹{each?.Product_price} </p>
            </div>
            <div className="cont">
            ...
            <div className="cont">
              <p className="cont-p"> Location : {each?.Features} </p>
