...
const GetLeasling = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postData = async (e) => {
      ...
      Array.from(leaselisting_images).forE
      fd.append("leaselisting_images" , leaselisting_images)

      try{
        const { data } = await axios.post("http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:2000/leaselisting/addByadmin/")
      }catch(err){
        console.log(err)
      }
    }
