...
const SubCategory = () => {
  ...
  const deleteCat = async (id) => {
    try {
      const data = await axios.delete(
        `http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:2000/subcategory/delete/${id}`,
        {
          headers: {
  ...
  function DetailModal(props) {
    ...
    const fetchSingleCategory = useCallback(async () => {
      try {
        const { data } = await axios.get(
          `http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:2000/subcategory/getSubcategory/${id}`
        );
        setEachData(data);
      } catch (e) {
        console.log(e);
        ...
        <Modal.Body>
          <Container>
            ...
            <div className="cont">
              ...
              <p className="cont-p">
                {" "}
                Category : {eachData?.[0]?.Category?.category}{" "}
              </p>
            </div>
          </Container>
        </Modal.Body>
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const submitHandler = async (e) => {
      ...
      try {
        const data = await axios.post(
          "http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:2000/subcategory/add/subcategory",
    ...
    const EditHandler = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          `http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:2000/subcategory/edit/subcategory/${id}`,
          { image: imageUrl, Category, subcategory }
        );
        console.log(data);
        toast.success("Added");
