...
const SubCategory = () => {
        ...
        <Modal.Body>
          <Container>
            ...
            <div className="cont">
              ...
              <p className="cont-p"> Category :  {eachData?.[0]?.Category?.category} </p>
            </div>
          </Container>
        </Modal.Body>
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const EditHandler = async (e) => {
      e.preventDefault()
      try{
        const { data } = await axios.post(`http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:2000/subcategory/edit/subcategory/${id}` , { image: imageUrl, Category, subcategory })
        console.log(data)
        toast.success('Added')
        fetchData()
      }catch(e) { 
    ...
    return (
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-vcenter">
       {edit ? 'Edit Category' : "     Add Sub-Category"}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
