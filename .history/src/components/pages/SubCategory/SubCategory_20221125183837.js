...
const SubCategory = () => {
    ...
    const submitHandler = async (e) => {
      ...
      try {
        const data = await axios.post(
          "https://setupbazaar.herokuapp.com/subcategory/add/subcategory",
          fd,
          {
            headers: {
  ...
  const deleteCat = async (id) => {
    try {
      const data = await axios.delete(
        `https://setupbazaar.herokuapp.com/subcategory/delete/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const deleteAll = async () => {
    try {
      const data = await axios.delete(
        "https://setupbazaar.herokuapp.com/subcategory/deleteall",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
