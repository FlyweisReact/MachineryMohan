        ...
        <Modal.Body>
          <Container>
            <div className="manyImage">
              {each?.servicePictures?.map((i, index) => (
                <img src={i.img} alt="" key={index} />
              ))}
            </div>

            <div className="cont">
              <p className="cont-p"> Service name : {each?.Service_name} </p>
              <p className="cont-p"> Service_Price : ₹{each?.Service_Price} </p>
            </div>
            <div className="cont">
            ...
            <div className="cont">
              <p className="cont-p"> About service : {each?.About_service} </p>
