...
const Complaint = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postData = async (e) => {
      e.preventDefault()
      try{
          const { data } = await axios.post("http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:2000/package" , {image : url , price  , desc , valid } )
          console.log(data)
          props.onHide()
          ...
          <Container>
            <Form onSubmit={edit ? EditHandler : postData}>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control type="number" min={1} onChange={(e) => setPrice(e.target.value)} onClick={() => PostImage()} />
              </Form.Group>
