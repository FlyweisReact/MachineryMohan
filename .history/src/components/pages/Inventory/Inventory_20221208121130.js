      ...
      >
        ...
        <tbody>
          {data?.categories?.map((i, index) => (
            <tr key={index}>
              <td>
                <img src={i.categoryimg ? i.categoryimg : 'https://64.media.tumblr.com/33144c8e6571324bd1f8f1ab2665ad29/0bd02ebacee59266-2b/s1280x1920/4885b8949a193977235c323f9a819bf7ab7535a8.jpg'} alt="" className="fast-food" />
              </td>
              <td> {i.category} </td>
              <td>
                <AiFillDelete
