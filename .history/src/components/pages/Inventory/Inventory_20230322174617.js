...
const Inventory = () => {
  ...
  function DetailModal(props) {
    ...
    const fetchSingleCategory  = async () => {
      try{
          const { data } = await axios.get(`http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:2000/category/getone/${id}`)
          console.log(data)
      }catch(e) {
        console.log(e)
      }
            ...
            <tr key={index}>
              ...
              <td>
                <div className="d-flex gap-2">
                  ...
                  ></i>
                  <i class="fa-solid fa-eye"  style={{ cursor: "pointer", color: "blue" }} onClick={() => deleteCat(i._id)}></i>
                </div>
              </td>
            </tr>
          ))}
