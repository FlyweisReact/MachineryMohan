        ...
        <Modal.Body>
          <Container style={{ width: "600px" }}>
            <Form onSubmit={AddProduct}>
              ...
              <Form.Group className="mb-3" controlId="formBasicEmail" >
                <Form.Select aria-label="Default select example" onChange={(e) => setC(e.target.value)}>
              ...
              <Form.Group className="mb-3" controlId="formBasicEmail"  onChange={(e) => setC(e.target.value)}>
