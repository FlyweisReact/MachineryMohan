...
const Products = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const AddProduct = async (e) => {
      e.preventDefault();
      try {
        const { data } = await axios.post("http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:2000/product/add/" , { image : imageUrl , productcategory , subCategory , Product_name})
      } catch (e) {
        console.log(e);
      }
    };
