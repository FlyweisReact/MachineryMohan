      ...
      >
        ...
        <tbody>
          {data?.map((i, index) => (
            <tr key={index}>
              <td>
                {i.machinePictures === null ? <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGD6ZjF1tWOz93cQVpEVJFn0zHF2-1f_4-8w&usqp=CAU' alt=''  class/> : "Image"}
              </td>
              ...
              <td style={{ display: "flex", gap: "10px" }}>
                ...
                <AiOutlineEye color="blue" cursor="pointer" />
