...
const Machine = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const cloudinaryCore = new cloudinary.Cloudinary({
      cloud_name: "dbcnha741",
      api_key: "865815848694583",
      api_secret: "j90xHfvjplpGsIlQxLw0De0SiwU"
    });

    const cloudinaryContext = {
      cloudName: "dbcnha741",
      apiKey: "865815848694583",
      apiSecret: "j90xHfvjplpGsIlQxLw0De0SiwU"
    };
    ...
    const handleInputChange = event => {
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        reader.onloadend = () => {
          images.push({ id: uuidv4(), data: reader.result });
    ...
    const handleImageUpload = async () => {
      ...
      for (let i = 0; i < selectedImages.length; i++) {
        ...
        uploadedImages.push({ id: image.id, publicId: result.public_id });
      }
