          ...
          <Container style={{ width: "600px" }}>
            <Form>
              ...
              <Form.Group className="mb-3" controlId="formBasicPassword">
                ...
                <Form.Control type="number" onChange={(e) => setMachineName(e.target.value)} />
              </Form.Group>
              <Form.Group className="mb-3" controlId="formBasicPassword">
                <Form.Label>Price</Form.Label>
                <Form.Control type="number" min={1} onChange={(e) => setMachineName(e.target.value)} />
              </Form.Group>
              <Form.Group className="mb-3" controlId="formBasicPassword">
              ...
              <Form.Group className="mb-3" controlId="formBasicPassword">
                ...
                <Form.Control type="file" multiple  onChange={(e) => setMachineName(e.target.value)}/>
              </Form.Group>
              <Form.Group className="mb-3" controlId="formBasicPassword">
              ...
              <FloatingLabel
                ...
                className="mb-3"
              >
                <Form.Control as="textarea"  onChange={(e) => setMachineName(e.target.value)}/>
              </FloatingLabel>
