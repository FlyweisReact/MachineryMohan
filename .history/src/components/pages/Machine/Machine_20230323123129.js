        ...
        <Modal.Body>
          <Container>
            ...
            <div className="cont">
              ...
              <p className="cont-p"> Speed : {each?.Speed} </p>
            </div>
            <div className="cont">
              <p className="cont-p">
                {" "}
                Output paper width : {each?.Output_paper_width}{" "}
              </p>
              <p className="cont-p"> Capacity : {each?.Capacity} </p>
            </div>
            <div className="cont">
              <p className="cont-p">
                {" "}
                Model name number : {each?.Model_name_number}{" "}
              </p>
              <p className="cont-p"> Brand : {each?.Brand} </p>
            </div>
            <div className="cont">
              <p className="cont-p">Model_no: {each?.Model_name_number} </p>
              <p className="cont-p"> Brand : {each?.Brand} </p>
            </div>
          </Container>
        </Modal.Body>
