...
const Machine = () => {
  ...
  function ViewModal(props) {
    ...
    const fetchData = async () => {
      try{
        const { data } = await axios.get(`http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:2000/machine/get/63fca79225743997ab672001`)
      }catch(e) { 
        console.log(e)
      }
    } 
            ...
            {data?.map((i, index) => (
              <tr key={index}>
                ...
                <td style={{ display: "flex", gap: "10px" }}>
                  ...
                  ></i>
                  <i class="fa-solid fa-eye" onClick={() => {}}></i>
                </td>
              </tr>
            ))}
          </tbody>
