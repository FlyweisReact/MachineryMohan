...
const Cat = () => {
        ...
        <Modal.Body>
          ...
          >
            ...
            <Form.Group className="mb-3" controlId="formBasicEmail">
              ...
              <Form.Control type="text" placeholder="New" required onClick={() => PostImage()} onChange={(e) => setBannerName(e.target.value)} />
            </Form.Group>
  ...
  const deleteData = async (id) => {
    try{
      const { data } =  await axios.delete(`http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:2000/banner/delete/banner/638464bf0a9afaca63471770`)
    }catch(err){
      console.log(err)
    }
  }
