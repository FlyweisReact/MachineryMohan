...
import { BsFillImageFill ,BsFillCartCheckFill } from "react-icons/bs";
import { GiNothingToSay } from "react-icons/gi";
import {BsCartFill} from 'react-icons/bs'
import {
  MdDashboardCustomize,
  MdPayment,MdCategory
} from "react-icons/md";
...
const Sidebar = ({ hamb, setHamb }) => {
  ...
  const nav = [
    ...
    {
      icon: <BsFillCartCheckFill className="text-xl mr-3" />,
      link: "/orders",
      name: "Orders",
    },
    {
      icon: <TbDiscount2 className="text-xl mr-3" />,
      link: "/coupon",
      name: "Coupons",
    },
    {
